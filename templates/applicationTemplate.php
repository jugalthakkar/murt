<div class="ui fixed inverted menu" >
    {{#link-to 'index' class='ui item header title'}}
    <img src="images/cyberscooty-tux-graduate.svg" alt="Mumbai University Result Tracker" />
    &nbsp;&nbsp;&nbsp;&nbsp;<abbr title="Mumbai University Result Tracker">MURT</abbr>
    {{/link-to}}

    <a href="http://muresulttracker.tk/rss/"  class="item ui icon header floating right" target="_blank">
        <i class=" orange rss link icon"></i>RSS
    </a>
    <a href="https://twitter.com/muresulttracker" class="item ui icon header floating right" target="_blank">
        <i class="blue twitter link icon"></i>Twitter
    </a>
    <a href="https://www.facebook.com/muresults" class="item ui icon header floating right" target="_blank">
        <i class="blue facebook link icon"></i>Facebook
    </a>
    {{#link-to 'visualization' class='item ui icon header floating right'}}
    <i class="red bar chart link icon"></i>Visualize
    {{/link-to}}
    {{#link-to 'android' class='item ui icon header floating right'}}
