...
//                    console.log('redrawing: ' + scope.config.type + ' results: '+scope.results.length);
                            ...
                            var width=$container.closest('.container').width();
                            var commonOptions = {
                                yAxis: {
                                    title: {
                                        text: 'No. of Results'
                            ...
                            switch (scope.config.type) {
                                case 'column':
                                    $container.highcharts(_.extend(scope.getColumnChartOptions(width), commonOptions));
                                    break;
                                case 'timeline':
                                    $container.highcharts('StockChart', _.extend(scope.getTimelineOptions(width), commonOptions));
                                    break;
                            }                    
